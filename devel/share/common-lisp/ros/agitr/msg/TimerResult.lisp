...
(cl:defmethod cl:initialize-instance :after ((m <TimerResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agitr-msg:<TimerResult> is deprecated: use agitr-msg:TimerResult instead.")))
...
(cl:defmethod updates_sent-val ((m <TimerResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agitr-msg:updates_sent-val is deprecated.  Use agitr-msg:updates_sent instead.")
  (updates_sent m))
